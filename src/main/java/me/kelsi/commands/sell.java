...
public class sell extends ListenerAdapter {
    ...
    public void onSlashCommandInteraction(SlashCommandInteractionEvent event) {
        ...
        if (money.containsKey(user1)) {
            moneystone = stone.get(user1) * 1.1;
            moneycoal = coal.get(user1) * 1.2;
            moneyiron = iron.get(user1) * 1.3;
            moneygold = gold.get(user1) * 1.4;
            moneydiamond = diamond.get(user1) * 1.5;
            moneyemerald = emerald.get(user1) * 1.7;
